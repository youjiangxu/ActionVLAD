...
python \
  ...
  --frames_per_video 10 \
  --iter_size 2 \
  --checkpoint_path models/Experiments/VGG_RGB_UCF_seqvlad_with_redu_pretrained_stage3_3 \
  --checkpoint_style v2_withStream \
  --train_dir models/Experiments/VGG_RGB_UCF_seqvlad_with_redu_pretrained_stage4_3 \
