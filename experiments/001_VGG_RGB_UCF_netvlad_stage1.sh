...
LD_PRELOAD=/usr/lib/libtcmalloc.so.4 \
  ...
  --train_dir models/Experiments/001_VGG_RGB_UCF_netvlad_stage1 \
  ...
  --bgr_flip True \
  --pooling netvlad \
  --netvlad_initCenters models/experiments/001_VGG_RGB_UCF_netvlad_stage1/Features/imnet_conv5_kmeans64.pkl \
  --pooled_dropout 0.5 \
